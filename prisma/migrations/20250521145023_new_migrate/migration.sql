...
-- CreateTable
CREATE TABLE `JadwalProgramSiswa` (
    `id` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Pendaftaran` ADD CONSTRAINT `Pendaftaran_voucher_id_fkey` FOREIGN KEY (`voucher_id`) REFERENCES `Voucher`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ProgramSiswa` ADD CONSTRAINT `ProgramSiswa_kelasProgramId_fkey` FOREIGN KEY (`kelasProgramId`) REFERENCES `KelasProgram`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JadwalProgramSiswa` ADD CONSTRAINT `JadwalProgramSiswa_programSiswaId_fkey` FOREIGN KEY (`programSiswaId`) REFERENCES `ProgramSiswa`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `JadwalProgramSiswa` ADD CONSTRAINT `JadwalProgramSiswa_jamMengajarId_fkey` FOREIGN KEY (`jamMengajarId`) REFERENCES `JamMengajar`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `AbsensiSiswa` ADD CONSTRAINT `AbsensiSiswa_siswaId_fkey` FOREIGN KEY (`siswaId`) REFERENCES `Siswa`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `PeriodeSpp` ADD CONSTRAINT `PeriodeSpp_voucher_id_fkey` FOREIGN KEY (`voucher_id`) REFERENCES `Voucher`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
